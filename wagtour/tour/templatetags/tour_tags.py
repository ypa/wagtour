...
@register.inclusion_tag('tour/tags/top_menu.html', takes_context=True)
...
@register.inclusion_tag('tour/tags/top_menu_children.html', takes_context=True)
...
@register.inclusion_tag('tour/tags/secondary_menu.html', takes_context=True)
...
@register.inclusion_tag(
    'tour/tags/standard_index_listing.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'tour/tags/person_listing_homepage.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'tour/tags/blog_listing_homepage.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'tour/tags/event_listing_homepage.html',
    takes_context=True
)
...
# Advert snippets
@register.inclusion_tag('tour/tags/adverts.html', takes_context=True)
def adverts(context):
    return {
