...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tour_homepagecarouselitem', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='carousel_items', to=orm['tour.HomePage'])),
        ))
        db.send_create_signal(u'tour', ['HomePageCarouselItem'])

        # Adding model 'HomePageRelatedLink'
        db.create_table(u'tour_homepagerelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('link_external', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('link_page', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page'])),
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_links', to=orm['tour.HomePage'])),
        ))
        db.send_create_signal(u'tour', ['HomePageRelatedLink'])

        # Adding model 'HomePage'
        db.create_table(u'tour_homepage', (
        ...
        db.send_create_signal(u'tour', ['HomePage'])


    def backwards(self, orm):
        # Deleting model 'HomePageCarouselItem'
        db.delete_table(u'tour_homepagecarouselitem')

        # Deleting model 'HomePageRelatedLink'
        db.delete_table(u'tour_homepagerelatedlink')

        # Deleting model 'HomePage'
        db.delete_table(u'tour_homepage')
    ...
    models = {
        ...
        u'tour.homepagecarouselitem': {
            ...
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'carousel_items'", 'to': u"orm['tour.HomePage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'tour.homepagerelatedlink': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'HomePageRelatedLink'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link_document': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['wagtaildocs.Document']"}),
            'link_external': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'link_page': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['wagtailcore.Page']"}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'related_links'", 'to': u"orm['tour.HomePage']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
