...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wagtour_blogindexpagerelatedlink', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_links', to=orm['wagtour.BlogIndexPage'])),
        ))
        db.send_create_signal(u'wagtour', ['BlogIndexPageRelatedLink'])

        # Adding model 'BlogIndexPage'
        db.create_table(u'wagtour_blogindexpage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('intro', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal(u'wagtour', ['BlogIndexPage'])


    def backwards(self, orm):
        # Deleting model 'BlogIndexPageRelatedLink'
        db.delete_table(u'wagtour_blogindexpagerelatedlink')

        # Deleting model 'BlogIndexPage'
        db.delete_table(u'wagtour_blogindexpage')
    ...
    models = {
        ...
        u'wagtour.blogindexpagerelatedlink': {
            ...
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'related_links'", 'to': u"orm['wagtour.BlogIndexPage']"}),
